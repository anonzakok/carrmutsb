...
<head>
  ...
  <title>เพิ่ม รายการขอยานพาหนะ</title>
...
<?php
        ...
        if (isset($_POST['Submit'])) {
            ...
            // echo $_POST['note']. "<br>";
            $sql = "INSERT INTO `booking` (`booking_id`, `car_number`, `date_start`,`time_car`, `place`, `driver`, `number`, `re_name`,`re_name2`,`re_name3`, `faculty`,`note`, `date_b`) 
                    VALUES (NULL, '".$_POST['car_number']."', '".$_POST['date_start']." ".$_POST['time_car']."', '".$_POST['time_car']."', '".$_POST['place']."', '".$_POST['driver']."', '".$_POST['number']."', '".$_POST['re_name']."', '".$_POST['re_name2']."', '".$_POST['re_name3']."', '".$_POST['faculty']."', '".$_POST['note']."','".$_POST['date_start']." ".'23:59:59'."');";
...
<?php if (empty($_SESSION['status'])){
  ...
  <div id="wrapper">
            ...
            <div class="col-md-8 mx-auto mt-5 ">
                <div class="card">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <h3><b>++เพิ่มข้อมูลตารางออกรถ++</b></h3></br>
    ...
    function EnableDisableTextBox1(ddlModels) {
        ...
        txtOther1.disabled = selectedValue == 8 ? false : true;
            ...
            txtOther1.focus();
                        ...
                        <div class="form-group row">
                            <label for="date_start" class="col-sm-3 col-form-label">วันที่ออกเดินทาง</label>
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="date_start" name="date_start" require>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="time_car" class="col-sm-3 col-form-label">เวลา</label>
                                <div class="col-sm-9">
                                    <input type="time" class="form-control" id="time_car" name="time_car" required>
                                </div> 
                            </div> 
        ...
        if (!txtOther.disabled) {
            txtOther.focus();
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="re_name" name="re_name" required>
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            txtOther2.focus();
                            ...
                            <div class="form-group row">
                                ...
                                <select id = "ddlModels" onchange = "EnableDisableTextBox2(this)" class="form-control" name="note"  required>
                                 <option ><font color='grren'>อนุมัติ</font></option>
                                        <option value="2" ><font color='red'><b>ยกเลิก</b></font></option>
                                    </select>
...
if(file_exists("addbookingcount.txt")){ 
  // file_exists() คือ Function ที่ใช้ในการตรวจสอบไฟล์ หากไฟล์นั้นมีอยู่จริงจะคืนค่า true 
  
     $f=fopen("addbookingcount.txt","r"); //เปิดไฟล์เพื่ออ่านค่า
