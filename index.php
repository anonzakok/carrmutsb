...
$query = "SELECT * FROM booking where date_start  BETWEEN '$today_date' AND '$date_5'";
if (isset($_POST['cmdsearch'])){
    $query.=" AND car_number LIKE '%".$_POST['car_number']."%' ";
}
$query.="ORDER BY  DAY(date_start) ASC ,MONTH(date_start) ASC" or die("Error:" . mysqli_error()); 
...
echo"<div class='card mb-3'>
          ...
          เลือกรถที่ต้องการ <select id='car_number' class'form-control' name='car_number' >
              ...
              <table class='table table-bordered'  width='100%' cellspacing='0'>
                <thead>
                  <tr>
                    ...
                    <th scope='col 'style='text-align: center;'>ทะเบียน</th>
                    <th scope='col 'style='text-align: center;'>พขร</th>
...
while($row = mysqli_fetch_array($result)) { 
  ...
  if($row["note"]=='อนุมัติ'){
    ...
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .date_format(new DateTime($row['date_start']),"j/m/Y"). "</b></td>";;
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .date_format(new DateTime($row['time_car']),"H:i ")."</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .$row["place"] . "</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .$row["car_number"] . "</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .$row["driver"] . "</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .$row["number"] . "</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .$row["re_name"] ."</br>"
    .$row["re_name2"] ."</br>"
    .$row["re_name3"] ."</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;'><b>" .$row["faculty"] . "</b></td>";
    echo "<td bgcolor='#c3d98c' style='text-align: center;' ><font color='green'><b>".$row["note"] ."</b></font></td>";
  }
    else {
      echo "<td bgcolor='#f2a6a6' style='text-align: center;'><b>" .date_format(new DateTime($row['date_start']),"j/m/Y"). "</b></td>";;
      echo "<td bgcolor='#f2a6a6' style='text-align: center;'><font color='red'><b>" .date_format(new DateTime($row['time_car']),"H:i")."</b></font></td>";
      echo "<td bgcolor='#f2a6a6' style='text-align: center;'><font color='red'><b>".$row["place"] ."</b></font></td>";
      echo "<td bgcolor='#f2a6a6' style='text-align: center;'><font color='red'><b>".$row["car_number"] ."</b></font></td>";
      echo "<td bgcolor='#f2a6a6' style='text-align: center;'><font color='red'><b>".$row["driver"] ."</b></font></td>";
   
      echo "<td bgcolor='#f2a6a6' style='text-align: center;'><font color='red'><b>".$row["number"] ."</b></font></td>";
      echo "<td bgcolor='#f2a6a6' style='text-align: center;' ><font color='red'><b>".$row["re_name"] ."<br>"
      .$row["re_name2"] ."</br>"
      .$row["re_name3"] ."</b></font></td>";
      echo "<td bgcolor='#f2a6a6' style='text-align: center;' ><font color='red'><b>".$row["faculty"] ."</b></font></td>";
      echo "<td bgcolor='#f2a6a6' style='text-align: center;' ><font color='red'><b>".$row["note"] ."</b></font></td>";
    }
